    ...
    public struct RobotActions
    {
        ...
        public void SetCallbacks(IRobotActions instance)
        {
            if (m_Wrapper.m_RobotActionsCallbackInterface != null)
            {
                ...
                @Crouch.started -= m_Wrapper.m_RobotActionsCallbackInterface.OnCrouch;
                @Crouch.performed -= m_Wrapper.m_RobotActionsCallbackInterface.OnCrouch;
                @Crouch.canceled -= m_Wrapper.m_RobotActionsCallbackInterface.OnCrouch;
            }
